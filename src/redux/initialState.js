const initialState = { 
  lists: [ {id: '1', title: 'Things to do', description: 'Interesting things I want to check out'},
  {id: '2', title: 'Test List', description: 'Lorem ipsum'}
  ],
  columns: [ { id: '1', listId: '1', title: 'Books', icon: 'book', },
   { id: '2', listId: '1', title: 'Movies', icon: 'film', }, 
   { id: '3', listId: '1', title: 'Games', icon: 'gamepad', },
   {id: '4', listId: '2' , title: 'Song', icon: 'book'} ], 
  cards: [ { id: '1', columnId: '1', title: 'This is Going to Hurt', isFavorite: false}, 
